...
return <div ref={ref} className="flex flex-col md:flex-row gap-10 justify-between items-center bg-[url('../../../images/village.svg')] bg-cover mt-[120px]">
    <motion.section variants={parentVariants} initial="hidden" animate="visible" className="flex flex-col items-center md:items-start max-w-[560px] gap-16 md:gap-20">
     ...
     <motion.button variants={childVariants}  whileHover={{marginLeft:"20px",scale:1.02}} className="border-y-2 p-3 border-[rgb(175,105,0)] font-Baskerville w-1/2" onClick={()=> props.scrollToSection("history")}>SEE HOW IT IS MADE</motion.button>
     </div>
    </motion.section>
    <img className="md:w-[45%] md:min-w-[350px]" src="../assets/bottle_hero.svg" alt="wine bottle artwork" />
    </div>
})
