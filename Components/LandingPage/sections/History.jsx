 ...
 const array2  = [
   ...
   return <div ref={ref} className="flex flex-col gap-20 bg-[#F5EBDA]">
        ...
        <section className="flex flex-col items-center md:flex-row md:justify-around w-full gap-5 relative">
            <img className="absolute top-1/3 right-[-100px] w-1/2 rounded max-md:hidden" src="../public/images/village(2).png" alt="" />
            <img className="absolute top-1/3 left-[200px]" src="../public/assets/tree.png" alt="" />
